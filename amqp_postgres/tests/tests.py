...
class Test(unittest.TestCase):
    ...
    def _assert_log(self, log, db_log):
        ...
        db_timestamp = '{0}Z'.format(db_log[11].isoformat()[:-3])
        ...
        self.assertEqual(db_timestamp, log['timestamp'])  # reported_timestamp
    ...
    def _assert_event(self, event, db_event):
        ...
        db_timestamp = '{0}Z'.format(db_event[11].isoformat()[:-3])
        ...
        self.assertEqual(db_timestamp, event['timestamp'])  # reported_ts
